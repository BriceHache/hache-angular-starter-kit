    ...
    bindSummaryChart() {
        if (this.model) {
            ...
            this.OverviewChartData = [{
                data: [this.model.OpenTickets, 
                    this.model.ClosedTickets,
                     this.model.PendingTickets, 
                     this.model.UnAssignedTickets,
                      this.model.OverdueTickets, 
                      this.model.DueTodayTickets]
            }];
            this.OverviewChartOptions = {
               ...
               // colors: ['#1991EB', '#FF0017', '#fb9678', '#FFC105', '#e83e8c', '#e83e8c']
            }
